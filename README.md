...
<img src="https://raw.githubusercontent.com/Ymilagros/Ymilagros/master/avatar.png" width="200" style="border-radius:50%;border:3px solid #8B2FC9;" alt="Milagros Gil"/>
...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=8B2FC9&center=true&vCenter=true&width=600&lines=Software+Engineering+Student+%F0%9F%8E%93;Mobile+Developer+%7C+Flutter+%26+Firebase+%F0%9F%93%B1;Visual+Artist+%7C+Painting+%26+Sculpture+%F0%9F%8E%A8;AI+Explorer+%26+Tech+Curious+%F0%9F%A4%96;Dreamer+with+astronaut+code+%F0%9F%9A%80)
...
```dart
class MilagrosGil {
  final String nombre    = "Milagros Gil Hernández";
  final String rol       = "Software Engineering Student";
  final String universidad = "Universidad Manuela Beltrán — UMB";
  final String ubicacion = "Colombia 🇨🇴";

  final List<String> pasiones = [
    "Desarrollo móvil 📱",
  ...
  final String frase =
    "Donde el código se encuentra con el arte";
}
```
...
> *"Epifanía"* · *Medusa* · *Frida Kahlo Series*
...
[![GitHub](https://img.shields.io/badge/GitHub-Ymilagros-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Ymilagros)
